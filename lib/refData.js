  ...
  getCurrentV3() {
    return new Promise((resolve, reject) => {
      getLocalTimetableIds().then((manifest) => {
        ...
        return (timetableIdInfo.isSynced || true) ? this.getLocalV3Json() : this.getRemoteV3Json();
      }).then((currentV3) => {
  ...
  getCurrentV8() {
    return new Promise((resolve, reject) => {
      getLocalTimetableIds().then((manifest) => {
        ...
        return (timetableIdInfo.isSynced || true) ? this.getLocalV8Json() : this.getRemoteV8Json();
      }).then((currentV8) => {
