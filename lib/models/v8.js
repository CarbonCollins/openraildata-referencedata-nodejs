...
class V8RefData {
   ...
   * @returns {module:openraildata/common.Schedule[]} returns a cancellation reason
   */
  findSchedule(input) {
   ...
   * @param {module:openraildata/common.Schedule} schedule a new/updated schedule to be added to the reference data
   */
   ...
   * @returns {module:openraildata/common.Association} an Association or returns a null if an association was not found
   */
   ...
   * @returns {module:openraildata/common.Schedule[]}
   */
