 ...
 * @external CommonAssociation
 * @see {@link https://github.com/CarbonCollins/openraildata-common-nodejs/blob/master/docs/api.md#module_openraildata/common+Location|openraildata/common.Association}
 */
...
module.exports = (SuperClass) => {
   ...
   * @extends external:CommonAssociation
   */
