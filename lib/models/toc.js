...
let s_toc = Symbol('toc');
let s_tocname = Symbol('tocname');
let s_url = Symbol('url');

/**
 * @class
 * @memberof module:openraildata/referencedata
 * @augments module:openraildata/referencedata.TOC
...
class TOC {
  ...
  /**
   * @member {String} code
   * @memberof module:openraildata/referencedata.TOC
