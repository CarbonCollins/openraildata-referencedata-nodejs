...
const RefStation = require('../lib/models/refStation');

const ORDC = require('../../openraildata-common-nodejs');
const { StationA } = require('../../openraildata-common-nodejs');

console.log(ORDC.Station);
ORDC.StationMixin(RefStation);
console.log(ORDC.Station);
