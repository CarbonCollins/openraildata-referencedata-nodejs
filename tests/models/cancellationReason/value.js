...
const model = require('../../../lib/es5/models/cancellationReason');

const standardConfig = require('../../templates/cancellationReason/cancellationReason.json');
...
module.exports = function () {
  describe('Value suite', function () {
    it('Should construct with no input', function() {
      ...
      expect(unit).to.be.an.instanceOf(model.CancellationReason);
    ...
    it('Should create a valid instance', function () {
      const unit = new model.CancellationReason(standardConfig);
